...
int main()
{
    ...
    s_x1 = get_len_segment(figure[0].x, figure[0].y, pt.x, pt.y);
    s_x2 = get_len_segment(figure[1].x, figure[1].y, pt.x, pt.y);
    s_x3 = get_len_segment(figure[2].x, figure[2].y, pt.x, pt.y);
    s_x4 = get_len_segment(figure[3].x, figure[3].y, pt.x, pt.y);

    area3 = get_area_triangle(s1, s_x1, s_x2);
    area4 = get_area_triangle(s2, s_x2, s_x3);
    area5 = get_area_triangle(s3, s_x3, s_x4);
    area6 = get_area_triangle(s4, s_x4, s_x1);
